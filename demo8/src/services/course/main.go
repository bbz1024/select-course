...
import (
	...
	"select-course/demo8/src/utils/discovery"
	"select-course/demo8/src/utils/limiter"
	"select-course/demo8/src/utils/local"
	"select-course/demo8/src/utils/logger"
	"select-course/demo8/src/utils/promet"
...
func main() {
	...
	rpcServer := grpc.NewServer(
		...
		//grpc.UnaryInterceptor(dtmgimp.GrpcServerLog),
	)

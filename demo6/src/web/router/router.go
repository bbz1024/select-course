...
import (
	...
	"select-course/demo6/src/constant/config"
	"select-course/demo6/src/constant/services"
	"select-course/demo6/src/web/router/middleware"
	"select-course/demo6/src/web/services/courses"
	"select-course/demo6/src/web/services/users"
)
